...
:ok
"%ProgramFiles%\Microsoft ActiveSync\CeAppMgr.exe" ".\Solucao_Install.ini"
if "%errorlevel%"=="1" goto end

"%windir%\WindowsMobile\CeAppMgr.exe" ".\Solucao_Install.ini"
if "%errorlevel%"=="1" goto end

CeAppMgr.exe ".\Solucao_Install.ini"
